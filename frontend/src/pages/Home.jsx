    ...
    <div className="full-home-page">
      ...
      <div className="left-panel">
        ...
        <div className="screen-box">
          ...
          <h1>-The Quiz App!</h1>
          <p>
            Please feel free to use any of our materials for your own review. We
            only ask that you sign in using your name, email, and school or
            study course. We don't send junk mail, sell your data or generally
            make a nuisance of ourselves. We use your info to track progress and
            show leaderboard results. Thanks for using our quiz app! If you
            prefer a lighter or darker mode there is a toggle in the footer you
            can use!
          </p>
        </div>
        <div className="screen-box">
          ...
          <div className="stats-panel">
            ...
            <div className="stat-list">
              <div className="stat-item">
                <span>🔥 Login Streak:</span> {loginStats.loginStreak} days
              </div>
              <div className="stat-item">
                <span>🧠 Quizzes Taken:</span> {userStats.totalQuizzesTaken}
              </div>
              <div className="stat-item">
              ...
              <div className="stat-item">
                ...
                {userStats.improvementRate.toFixed(2)}%
              </div>
              <div className="stat-item">
                <span>🎯 This Week:</span> {userStats.quizzesTakenThisWeek}
              </div>
              <div className="stat-item">
