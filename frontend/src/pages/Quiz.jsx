...
function Quiz() {
  ...
  const currentSubjectName =
    subjectList.find((s) => s.id === parseInt(selectedSubject))?.name ||
    selectedSubject;
                ...
                <div className="tv-static-wrapper">
                  ...
                  <div className="subject-overlay">
                    <div className="channel-select-panel">
                      <label htmlFor="subject" className="channel-label">
                        📡 Choose Your Channel:
                      </label>
                      <select
                        id="subject"
                      ...
                      <p className="channel-helper-text">
                        Please select a subject to begin the quiz.
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="quiz-summary">
                      ...
                      <div className="score-display">
                        <p>
                          Subject:{" "}
                          <b>
                            {quizSummary.subject?.name || currentSubjectName}
                          </b>
                          <br />
                        ...
                        <p>
                          ...
                          <b>
                            {quizSummary.startedAt
                              ? new Date(quizSummary.startedAt).toLocaleString()
                              : "N/A"}
                          </b>
                          <br />
                          Completed:{" "}
